...
public partial class SceneData : Node2D
{
	...
	public PackedScene SubLevelTwo {get; private set;} = GD.Load<PackedScene>("res://scenes/sub_level_2.tscn");
	public PackedScene SubLevelThree {get; private set;} = GD.Load<PackedScene>("res://scenes/sub_level_3.tscn");
	...
	public PackedScene WinScreen{get; private set;} = GD.Load<PackedScene>("res://scenes/win_screen.tscn");
